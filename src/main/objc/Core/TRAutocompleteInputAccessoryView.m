//
//  TRAutocompleteInputAccessoryView.m
//  Object Editor
//
...
@interface TRAutocompleteInputAccessoryView () <UICollectionViewDataSource, UICollectionViewDelegate>

@end

@implementation TRAutocompleteInputAccessoryView
{
...
- (id)initWithFrame:(CGRect)frame collectionViewLayout:(UICollectionViewLayout *)layout
{
    ...
    if (self)
    {
        ...
        [self registerClass:[TRAutocompleteCell class] forCellWithReuseIdentifier:TRAutocompleteCellReuseIdentifier];
...
#pragma mark - TRAutocompleteInputAccessoryView
...
{
    TRAutocompleteCell *cell = [self dequeueReusableCellWithReuseIdentifier:TRAutocompleteCellReuseIdentifier forIndexPath:indexPath];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CGSize size = [TRAutocompleteCell preferredSizeForString:suggestion];
